...
public class MedievalGame {
  ...
  private Player start(Scanner console) {
    ...
    System.out.println("  Enter 'y' to laod a game, 'n' to create a new game: ");
    ...
    while(true){
      addDelay(500);
      if (answer.equals("y")){
        System.out.println("\nAhh.. I knew I remembered you, what was your name again? Let me see if I can find your backback: ");
